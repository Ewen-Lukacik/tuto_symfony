 ...
 */
final class Version20241217152313 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe ADD category_id INT NULL');
        $this->addSql('UPDATE recipe SET category_id = 1');
        $this->addSql('ALTER TABLE recipe ALTER COLUMN category_id SET NOT NULL');
